		...
		<div class="as-section-content">
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'input_text'; ?>" id="<?php echo Config::PREFIX . 'input_text'; ?>" value="<?php echo esc_attr( stripslashes( $options['input_text'] ) ); ?>" placeholder="<?php esc_html_e( 'Text for the Input field', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'button_text'; ?>" id="<?php echo Config::PREFIX . 'button_text'; ?>" value="<?php echo esc_attr( stripslashes( $options['button_text'] ) ); ?>" placeholder="<?php esc_html_e( 'Text for the Button', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control">
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<select name="<?php echo Config::PREFIX . 'input_size'; ?>" id="<?php echo Config::PREFIX . 'input_size'; ?>">
						...
						for ( $i = 6; $i < 81; $i++ ) {
							echo '<option value="' . $i . '"' . selected( esc_attr( $options['input_font_size'] ), $i ) . '>' . $i . esc_html__( 'px', 'maintenance-mode-coming-soon' ) . '</option>';
						}
				...
				<div class="as-form-group">
					...
					<select name="<?php echo Config::PREFIX . 'button_size'; ?>" id="<?php echo Config::PREFIX . 'button_size'; ?>">
						<?php
							...
							// Loading font sizes with the help of a loop
						for ( $i = 6; $i < 81; $i++ ) {
							echo '<option value="' . $i . '"' . selected( esc_attr( $options['button_font_size'] ), $i ) . '>' . $i . esc_html__( 'px', 'maintenance-mode-coming-soon' ) . '</option>';
						}
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'input_color'; ?>" id="<?php echo Config::PREFIX . 'input_color'; ?>" value="<?php echo esc_attr( $options['input_font_color'] ); ?>" placeholder="<?php esc_html_e( 'Font color for the Input text', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'button_color'; ?>" id="<?php echo Config::PREFIX . 'button_color'; ?>" value="<?php echo esc_attr( $options['button_font_color'] ); ?>" placeholder="<?php esc_html_e( 'Font color for the Button text', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'input_bg'; ?>" id="<?php echo Config::PREFIX . 'input_bg'; ?>" value="<?php echo esc_attr( $options['input_bg'] ); ?>" placeholder="<?php esc_html_e( 'Background color for the Input field', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'button_bg'; ?>" id="<?php echo Config::PREFIX . 'button_bg'; ?>" value="<?php echo esc_attr( $options['button_bg'] ); ?>" placeholder="<?php esc_html_e( 'Background color for the Button', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'input_bg_hover'; ?>" id="<?php echo Config::PREFIX . 'input_bg_hover'; ?>" value="<?php echo esc_attr( $options['input_bg_hover'] ); ?>" placeholder="<?php esc_html_e( 'Background color for the Input field when it gets clicked', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'button_bg_hover'; ?>" id="<?php echo Config::PREFIX . 'button_bg_hover'; ?>" value="<?php echo esc_attr( $options['button_bg_hover'] ); ?>" placeholder="<?php esc_html_e( 'Background color for the Button on hover', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
				...
				<div class="as-form-group">
					...
					<select name="<?php echo Config::PREFIX . 'input_border_width'; ?>" id="<?php echo Config::PREFIX . 'input_border_width'; ?>">
						<?php
							...
							// Loading font sizes with the help of a loop
						for ( $i = 1; $i < 21; $i++ ) {
							echo '<option value="' . $i . '"' . selected( esc_attr( $options['input_border_width'] ), $i ) . '>' . $i . esc_html__( 'px', 'maintenance-mode-coming-soon' ) . '</option>';
						}
				...
				<div class="as-form-group">
					...
					<select name="<?php echo Config::PREFIX . 'button_border_width'; ?>" id="<?php echo Config::PREFIX . 'button_border_width'; ?>">
						<?php
							...
							// Loading font sizes with the help of a loop
						for ( $i = 1; $i < 21; $i++ ) {
							echo '<option value="' . $i . '"' . selected( esc_attr( $options['button_border_width'] ), $i ) . '>' . $i . esc_html__( 'px', 'maintenance-mode-coming-soon' ) . '</option>';
						}
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'input_border'; ?>" id="<?php echo Config::PREFIX . 'input_border'; ?>" value="<?php echo esc_attr( $options['input_border'] ); ?>" placeholder="<?php esc_html_e( 'Border color for the Input field', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'button_border'; ?>" id="<?php echo Config::PREFIX . 'button_border'; ?>" value="<?php echo esc_attr( $options['button_border'] ); ?>" placeholder="<?php esc_html_e( 'Border color for the Button', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'input_border_hover'; ?>" id="<?php echo Config::PREFIX . 'input_border_hover'; ?>" value="<?php echo esc_attr( $options['input_border_hover'] ); ?>" placeholder="<?php esc_html_e( 'Border color for the Input field when it gets clicked', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'button_border_hover'; ?>" id="<?php echo Config::PREFIX . 'button_border_hover'; ?>" value="<?php echo esc_attr( $options['button_border_hover'] ); ?>" placeholder="<?php esc_html_e( 'Border color for the Button on hover', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'success_background'; ?>" id="<?php echo Config::PREFIX . 'success_background'; ?>" value="<?php echo esc_attr( $options['success_background'] ); ?>" placeholder="<?php esc_html_e( 'Background color for the success message', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'success_color'; ?>" id="<?php echo Config::PREFIX . 'success_color'; ?>" value="<?php echo esc_attr( $options['success_color'] ); ?>" placeholder="<?php esc_html_e( 'Text color for the success message', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'error_background'; ?>" id="<?php echo Config::PREFIX . 'error_background'; ?>" value="<?php echo esc_attr( $options['error_background'] ); ?>" placeholder="<?php esc_html_e( 'Background color for the error message', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'error_color'; ?>" id="<?php echo Config::PREFIX . 'error_color'; ?>" value="<?php echo esc_attr( $options['error_color'] ); ?>" placeholder="<?php esc_html_e( 'Text color for the error message', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
