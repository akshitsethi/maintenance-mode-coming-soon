			...
			<div class="as-section-content">
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'status'; ?>" value="1"<?php checked( true, esc_attr( $options['basic']['status'] ) ); ?>>
					...
					<div class="as-form-group">
						...
						<input type="text" name="<?php echo Config::PREFIX . 'title'; ?>" id="<?php echo Config::PREFIX . 'title'; ?>" value="<?php echo esc_attr( stripslashes( $options['basic']['title'] ) ); ?>" placeholder="<?php esc_attr_e( 'Please provide a Page Title', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control">
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<textarea name="<?php echo Config::PREFIX . 'header'; ?>" id="<?php echo Config::PREFIX . 'header'; ?>" rows="3" placeholder="<?php esc_attr_e( 'Header text for the maintenance page', 'maintenance-mode-coming-soon' ); ?>"><?php echo esc_textarea( stripslashes( $options['basic']['header_text'] ) ); ?></textarea>
					...
					<div class="as-form-group">
						...
						<textarea name="<?php echo Config::PREFIX . 'secondary'; ?>" id="<?php echo Config::PREFIX . 'secondary'; ?>" rows="3" placeholder="<?php esc_attr_e( 'Secondary text for the maintenance page', 'maintenance-mode-coming-soon' ); ?>"><?php echo esc_textarea( stripslashes( $options['basic']['secondary_text'] ) ); ?></textarea>
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="text" name="<?php echo Config::PREFIX . 'antispam'; ?>" id="<?php echo Config::PREFIX . 'antispam'; ?>" value="<?php echo esc_attr( stripslashes( $options['basic']['antispam_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Please provide a Anti-spam Text', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control">
					...
					<div class="as-form-group">
						...
						<input type="text" name="<?php echo Config::PREFIX . 'custom_login'; ?>" id="<?php echo Config::PREFIX . 'custom_login'; ?>" value="<?php echo esc_attr( $options['basic']['custom_login_url'] ); ?>" placeholder="<?php esc_attr_e( 'Custom login URL', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control">
				...
				<div class="as-double-group as-clearfix">
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'showlogged'; ?>" value="1"<?php checked( true, esc_attr( $options['basic']['show_logged_in'] ) ); ?>>
					...
					<div class="as-form-group">
						...
						<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'excludese'; ?>" value="1"<?php checked( true, esc_attr( $options['basic']['exclude_se'] ) ); ?>>
				...
				<div class="as-elements">
					<ul id="arrange-items">
						<?php
							...
							$arrange = Config::$default_options['basic']['arrange'];

						if ( ! empty( $options['basic']['arrange'] ) ) {
							$arrange = explode( ',', $options['basic']['arrange'] );
						}
					...
					<input type="hidden" name="<?php echo Config::PREFIX . 'arrange'; ?>" id="<?php echo Config::PREFIX . 'arrange'; ?>" value="<?php echo esc_attr( $options['basic']['arrange'] ); ?>">
				</div><!-- .as-elements -->
				...
				<div class="as-form-group">
					...
					<textarea name="<?php echo Config::PREFIX . 'analytics'; ?>" id="<?php echo Config::PREFIX . 'analytics'; ?>" rows="5" placeholder="<?php esc_attr_e( 'Analytics code for the maintenance page', 'maintenance-mode-coming-soon' ); ?>"><?php echo esc_textarea( stripslashes( $options['basic']['analytics'] ) ); ?></textarea>
