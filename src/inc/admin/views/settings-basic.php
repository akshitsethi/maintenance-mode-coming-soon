		...
		<div class="as-section-content">
			<div class="as-double-group as-clearfix">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'title'; ?>" id="<?php echo Config::PREFIX . 'title'; ?>" value="<?php echo esc_attr_e( stripslashes( $options['title'] ) ); ?>" placeholder="<?php esc_attr_e( 'Please provide a Page Title', 'classic-coming-soon-maintenance-mode' ); ?>" class="as-form-control">
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'antispam'; ?>" id="<?php echo Config::PREFIX . 'antispam'; ?>" value="<?php echo esc_attr_e( stripslashes( $options['antispam_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Please provide a Anti-spam Text', 'classic-coming-soon-maintenance-mode' ); ?>" class="as-form-control">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'custom_login'; ?>" id="<?php echo Config::PREFIX . 'custom_login'; ?>" value="<?php echo esc_attr_e( $options['custom_login_url'] ); ?>" placeholder="<?php esc_attr_e( 'Custom login URL', 'classic-coming-soon-maintenance-mode' ); ?>" class="as-form-control">
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'showlogged'; ?>" value="1"<?php checked( true, $options['show_logged_in'] ); ?>>
				...
				<div class="as-form-group">
					...
					<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'excludese'; ?>" value="1"<?php checked( true, $options['exclude_se'] ); ?>>
