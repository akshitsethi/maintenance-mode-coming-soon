	...
	<div class="as-tile-body">
		...
		<div class="as-section-content">
			<div class="as-form-group">
				...
				<input type="checkbox" class="as-form-ios" name="<?php echo Config::PREFIX . 'disable'; ?>" value="1"<?php checked( true, $options['disable_settings'] ); ?>>
			...
			<div class="as-form-group">
				...
				<p class="as-form-help-block"><?php echo esc_html__( 'Custom HTML for the plugin goes over here. Please note that ', 'classic-coming-soon-maintenance-mode' ) . '<i style="color: #f96773">' . esc_html__( '[html], [head], [title], [meta], [body], and similar tags', 'classic-coming-soon-maintenance-mode' ) . '</i>' . __( ' are not required. Only provide content HTML for the page.', 'classic-coming-soon-maintenance-mode' ); ?></p>
