			...
			<div class="as-tile-body">
				...
				<div class="as-section-content">
					...
					<div class="as-form-group">
						...
						<textarea name="<?php echo Config::PREFIX . 'html'; ?>" id="<?php echo Config::PREFIX . 'html'; ?>" rows="8" placeholder="<?php esc_html_e( 'Custom HTML for the plugin', 'maintenance-mode-coming-soon' ); ?>"><?php echo esc_textarea( stripslashes( $options['custom_html'] ) ); ?></textarea>
					...
					<div class="as-form-group">
						...
						<textarea name="<?php echo Config::PREFIX . 'css'; ?>" id="<?php echo Config::PREFIX . 'css'; ?>" rows="8" placeholder="<?php esc_html_e( 'Custom CSS for the plugin', 'maintenance-mode-coming-soon' ); ?>"><?php echo esc_textarea( stripslashes( $options['custom_css'] ) ); ?></textarea>
