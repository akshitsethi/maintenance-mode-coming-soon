		...
		<div class="as-section-content">
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'overlay_color'; ?>" id="<?php echo Config::PREFIX . 'overlay_color'; ?>" value="<?php echo esc_attr( $options['content_bg'] ); ?>" placeholder="<?php esc_html_e( 'Background color for the content overlay', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'overlay_border_color'; ?>" id="<?php echo Config::PREFIX . 'overlay_border_color'; ?>" value="<?php echo esc_attr( $options['content_border'] ); ?>" placeholder="<?php esc_html_e( 'Border color for the content overlay', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
				...
				<div class="as-form-group">
					...
					<select name="<?php echo Config::PREFIX . 'overlay_border_width'; ?>" id="<?php echo Config::PREFIX . 'overlay_border_width'; ?>">
						<?php
							...
							// Loading font sizes with the help of a loop
						for ( $i = 1; $i < 21; $i++ ) {
							echo '<option value="' . $i . '"' . selected( esc_attr( $options['content_border_width'] ), $i ) . '>' . $i . esc_html__( 'px', 'maintenance-mode-coming-soon' ) . '</option>';
						}
				...
				<div class="as-form-group">
					...
					<select name="<?php echo Config::PREFIX . 'overlay_border_radius'; ?>" id="<?php echo Config::PREFIX . 'overlay_border_radius'; ?>">
						<?php
							...
							// Loading font sizes with the help of a loop
						for ( $i = 0; $i < 41; $i++ ) {
							echo '<option value="' . $i . '"' . selected( esc_attr( $options['content_border_radius'] ), $i ) . '>' . $i . esc_html__( 'px', 'maintenance-mode-coming-soon' ) . '</option>';
						}
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'width'; ?>" id="<?php echo Config::PREFIX . 'width'; ?>" value="<?php echo esc_attr( $options['content_width'] ); ?>" placeholder="<?php esc_html_e( 'Set content width for the page', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'color'; ?>" id="<?php echo Config::PREFIX . 'color'; ?>" value="<?php echo esc_attr( $options['bg_color'] ); ?>" placeholder="<?php esc_html_e( 'Background color for the page', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<select name="<?php echo Config::PREFIX . 'position'; ?>" id="<?php echo Config::PREFIX . 'position'; ?>">
						<option value="left"<?php selected( 'left', esc_attr( $options['content_position'] ) ); ?>><?php esc_html_e( 'Left', 'maintenance-mode-coming-soon' ); ?></option>
						<option value="center"<?php selected( 'center', esc_attr( $options['content_position'] ) ); ?>><?php esc_html_e( 'Center', 'maintenance-mode-coming-soon' ); ?></option>
						<option value="right"<?php selected( 'right', esc_attr( $options['content_position'] ) ); ?>><?php esc_html_e( 'Right', 'maintenance-mode-coming-soon' ); ?></option>
					</select>
				...
				<div class="as-form-group">
					...
					<select name="<?php echo Config::PREFIX . 'alignment'; ?>" id="<?php echo Config::PREFIX . 'alignment'; ?>">
						<option value="left"<?php selected( 'left', esc_attr( $options['content_alignment'] ) ); ?>><?php esc_html_e( 'Left', 'maintenance-mode-coming-soon' ); ?></option>
						<option value="center"<?php selected( 'center', esc_attr( $options['content_alignment'] ) ); ?>><?php esc_html_e( 'Center', 'maintenance-mode-coming-soon' ); ?></option>
						<option value="right"<?php selected( 'right', esc_attr( $options['content_alignment'] ) ); ?>><?php esc_html_e( 'Right', 'maintenance-mode-coming-soon' ); ?></option>
					</select>
				...
				<div class="as-form-group">
					...
					<select name="<?php echo Config::PREFIX . 'header_size'; ?>" id="<?php echo Config::PREFIX . 'header_size'; ?>">
						<?php
							...
							// Loading font sizes with the help of a loop
						for ( $i = 6; $i < 81; $i++ ) {
							echo '<option value="' . $i . '"' . selected( esc_attr( $options['header_font_size'] ), $i ) . '>' . $i . esc_html__( 'px', 'maintenance-mode-coming-soon' ) . '</option>';
						}
				...
				<div class="as-form-group">
					...
					<select name="<?php echo Config::PREFIX . 'secondary_size'; ?>" id="<?php echo Config::PREFIX . 'secondary_size'; ?>">
						<?php
							...
							// Loading font sizes with the help of a loop
						for ( $i = 6; $i < 81; $i++ ) {
							echo '<option value="' . $i . '"' . selected( esc_attr( $options['secondary_font_size'] ), $i ) . '>' . $i . esc_html__( 'px', 'maintenance-mode-coming-soon' ) . '</option>';
						}
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'header_color'; ?>" id="<?php echo Config::PREFIX . 'header_color'; ?>" value="<?php echo esc_attr( $options['header_font_color'] ); ?>" placeholder="<?php esc_html_e( 'Font color for the Header text', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'secondary_color'; ?>" id="<?php echo Config::PREFIX . 'secondary_color'; ?>" value="<?php echo esc_attr( $options['secondary_font_color'] ); ?>" placeholder="<?php esc_html_e( 'Font color for the Secondary text', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
			...
			<div class="as-double-group as-clearfix">
				<div class="as-form-group">
					...
					<select name="<?php echo Config::PREFIX . 'antispam_size'; ?>" id="<?php echo Config::PREFIX . 'antispam_size'; ?>">
						<?php
							...
							// Loading font sizes with the help of a loop
						for ( $i = 6; $i < 61; $i++ ) {
							echo '<option value="' . $i . '"' . selected( esc_attr( $options['antispam_font_size'] ), $i ) . '>' . $i . esc_html__( 'px', 'maintenance-mode-coming-soon' ) . '</option>';
						}
				...
				<div class="as-form-group">
					...
					<input type="text" name="<?php echo Config::PREFIX . 'antispam_color'; ?>" id="<?php echo Config::PREFIX . 'antispam_color'; ?>" value="<?php echo esc_attr( $options['antispam_font_color'] ); ?>" placeholder="<?php esc_html_e( 'Font color for the Antispam text', 'maintenance-mode-coming-soon' ); ?>" class="as-form-control jscolor {required:false}">
